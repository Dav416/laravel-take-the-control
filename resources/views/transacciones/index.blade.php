                ...
                <tbody>
                    @forelse($transacciones as $transaccion)
                        <tr>
                            ...
                            <td class="fw-bold {{ $transaccion->tipo->categoria_tipo_id === 1 && $transaccion->proyeccion_financiera_id === null ? 'text-success' : 'text-danger' }}">
                                {{ $transaccion->tipo->categoria_tipo_id === 1 && $transaccion->proyeccion_financiera_id === null ? '+' : '-' }}${{ number_format($transaccion->valor_transaccion, 0, ',', '.') }}
                            </td>
                            <td>
